...
const Intro = () => {
    return (
        <div className="card bg-white flex flex-col md:flex-row items-center justify-between gap-8 my-10 px-4 md:px-10">
            {/* Text Section */}
            <div className="flex-1 text-center md:text-left space-y-4">
                <h2 className="text-black text-3xl md:text-4xl font-bold">
                    Empower Your Restaurant with FlavorFusion
                </h2>
                <p className="text-black text-base md:text-lg leading-relaxed max-w-md mx-auto md:mx-0">
